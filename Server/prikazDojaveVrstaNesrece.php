	...
	<div id="wrapper">
		...
		<?php
			...
			function ispis(){
				...
				$query = 'SELECT * FROM dojave ORDER BY vrsta_nesrece LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
				...
				for ($page=1;$page<=$number_of_pages;$page++) {
				  echo '<a class="broj_stranice" href="prikazDojaveVrstaNesrece.php?page=' . $page . '">' . $page . '</a> ';
				}
				echo "</div>";
			}
		?>
